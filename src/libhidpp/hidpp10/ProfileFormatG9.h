...
#ifndef LIBHIDPP_HIDPP10_PROFILE_FORMAT_G9_H
#define LIBHIDPP_HIDPP10_PROFILE_FORMAT_G9_H
...
private:
	...
	static constexpr size_t ProfileSize = 56;
	static constexpr unsigned int MaxButtonCount = 10;
